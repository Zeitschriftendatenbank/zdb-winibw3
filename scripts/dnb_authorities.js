...
Historie:
2010-08-01 Stefan Grund		: erstellt, Ueberetzung der VB-Version
...
matArt = application.activeWindow.title.findTag("005",0,false,false,false).substr(0,2);
  ...
  var strcmd1 = "rec n;f per ";
  var strcmd2 = " and bbg tp#";
  var strcmd2 = " and bbg tp#";
  var pruef_zwang = "true";
  var set_zu_gross = 100;
  break;
  //Körperschaft
  case "510" : 
  boxtit = "Relationierung Körperschaft";
    if (exakt) {
    var strcmd1 = "rec n;f ksk ";
    } else {
    var strcmd1 = "rec n;f kor ";
    }
  var strcmd2 = " and bbg tb#";
  var pruef_zwang = "true";
  ...
  //Wenn Suchbegriff in Anfuehrungsstrichen -> Phrasensuche, sonst wortweise (default)
    ...
    var strcmd1 = "rec n;f sw ";
    }
    if (inh.substr(4,3) == "uwk") {
    var strcmd1 = "rec n;f ";
    }
  var strcmd2 = " and bbg tu#";
  var pruef_zwang = "true";
  var set_zu_gross = 1000;
  break;
  //Sachbegriff
  ...
  //Bei Geographica wird immer als Phrase gesucht, daher braucht "exakt" nicht abgefragt zu werden
  var strcmd1 = "rec n;f sp \u0022";  
    if (matArt == "Tp") {
    var strcmd2 = "?\u0022 not sn [0123456789]? and bbg tg#";
    } else {
    var strcmd2 = "\u0022 and bbg tg#";
    }
  var pruef_zwang = "true";
  var set_zu_gross = 1000;
  break;
...
newid = application.activeWindow.windowID;
	...
	application.activeWindow.title.insertText(strtmp + "$4" + relCode);
	return false;
	}
...
*/
  ...
  application.activateWindow(newid);
	...
	global.gndLinkkeep.newid = newid;
		global.gndLinkkeep.relCode = "$4" + relCode;
	return true;
	}
	...
	application.activeWindow.title.insertText( "!" + PPN + "!$4" + relCode );
...
var matErlaubt = "Ts Tg Tu";                             //Erlaubte Materialarten
...
fm_uebers = new Array();
  ...
  fm_uebers[1] = "375 " + fm;
  switch (fm) {
  case "f" : fm_uebers[2] = "550 !944106285!";
  break;
  case "m" : fm_uebers[2] = "550 !04061414X!";
  break;
  } 
  fm_uebers[2] = fm_uebers[2] + "$4funk";
...
pnd = "005 Tp4\n" +
  ...
  k012 = __geheZuKat("012","",true);
    ...
    // 899 vorhanden?
    if (__feldTest("692","","",false) == "fnw") {
    __geheZuKat("692","",true);
    application.activeWindow.title.insertText("\n692 ");
    }
...
var qeindat = jahr + RegExp.$2 + RegExp.$1;
rexp.exec(titz);
  if (RegExp.$3 > 80) {
  jahr = "19" + RegExp.$3;
  } else {
...
var zeindat = jahr + RegExp.$2 + RegExp.$1;
...
abweich = new Array() //Array für Zeilen des Quellsatzes, die im Zielsatz nicht vorhanden sind
qmbx_loesch = new Array() //Array für Mailboxtexte des Quellsatzes, die in den Zielsatz übernommen und daher im Quellsatz automatisch gelöscht werden können
//Definition von Feldern, die nie übernommen werden
f_nie = "Eing 005 020 026 027 |m| 169 903 |e| 903 |r| "
//Definition von Feldern, die immer übernommen werden
f_immer = "011 012 100 200 "
