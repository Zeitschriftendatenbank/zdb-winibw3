...
do {
  if (antw = "falsch") {
  boxTxt = "FALSCHE EINGABE! (" + erg + ")" + vbCr + "Nur " + werte + " eingeben!\n\n" + strTxt;
  } else {
  boxTxt = strTxt;
  }
  
erg = InputBox(boxTxt,boxtit,dflt)
  
  if (werte.indexOf(erg) > -1) { 
  antw = "wahr" 
  } else {
  antw = "falsch" 
  }
