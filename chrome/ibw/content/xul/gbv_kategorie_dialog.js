...
function richtlinieZETA()
{
	application.writeProfileString("Richtlinie", "Einrichtung", "ZETA");
	document.getElementById("idAuswahlRichtlinie").value = "Ausgewählte Richtlinie: ZETA";
