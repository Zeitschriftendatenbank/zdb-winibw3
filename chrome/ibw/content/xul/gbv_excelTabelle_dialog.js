 ...
 ***************************************************************************
 GBV: zahlreiche Änderungen:
      Trennzeichen: von Semikolon in Tab geändert.
 Fehler bzw. was noch fehlt: 
- Wenn das erste in der Konfigurationsdatei genannte Unterfeld einer Kategorie nicht vorkommt, 
   wird auch der Rest der Kategorie nicht ausgewertet.
- Erweiterung für originalschriftliche Datensätze
- Wiederholbare Kategorien: Nur das erste Vorkommnis wird berücksichtigt. 
  Gewünscht wird eine Reihung, Trennzeichen: Semikolon
- wiederholbare Unterfelder müssen ebenfalls gereiht werden, z.B. in 8200 kann $a mehrfach vorkommen
 ***************************************************************************
...
function onLoad()
{
	...
	document.getElementById("idLabelInfos4").value = "mit Ihren Angaben im obigen Feld übereinstimmt.";
...
function onAccept()
{
	...
	document.getElementById("idLabelErgebnis1").value = "";
	document.getElementById("idLabelErgebnis2").value = ""
...
function frageSpeichern(){
	if (bContentsChanged) {
		...
		if (prompt.confirmEx("Speichern?", "Änderungen in der Konfigurationstabelle speichern?", "Yes", "No", "", "", false) == 0) {
			auswahlSpeichern();
		}
		bContentsChanged = false;
	}
