...
//
// Revision:		Carsten Schulze (ZDB),
//					24.08.2010 changed save path from exemplarmasken to defaults\exemplarmasken
//============================================================================
...
var exNrAnfang, exNrEnde,checkboxExEingabe
const utility = 
{
...
try {
	...
	if (!theFileInput.openSpecial("ProfD", "\\defaults\\exemplarmasken\\" + theList.value)) {
		if (!theFileInput.openSpecial("BinDir", "\\defaults\\exemplarmasken\\" + theList.value)) {
...
try {
	...
	theFileOutput.createSpecial("ProfD", "\\defaults\\exemplarmasken\\" + currentFilename);
