...
pref("winibw.commandbar.font.name",      "Courier New");
...
// Preferences for the diacritics bar
// The size is in pixels (default 12)
pref("winibw.diacriticsbar.font.name",      "Tahoma");
pref("winibw.diacriticsbar.font.size",      14);
pref("winibw.diacriticsbar.font.color",     "#000000");
pref("winibw.diacriticsbar.font.style",     "regular");
pref("winibw.diacriticsbar.font.underline", false);
pref("winibw.diacriticsbar.background",     "ButtonFace");
pref("winibw.diacriticsbar.usebackground",  false);
...
// The size is in pixels (default 12)
pref("winibw.editscreen.font.name",      "Arial");
...
//pref("winibw.filelocation.download",  "file:///C:/download.dwl");
//pref("winibw.filelocation.print",     "resource:/chrome/ibw/content/WinIBW_Print.html");
pref("winibw.filelocation.titlecopy", "resource:/scripts/title.ttl");
pref("winibw.filelocation.downloadtoprinter",   false);
pref("winibw.filelocation.printtoprinter",      false);
pref("winibw.filelocation.titlecopytoprinter",  false);
...
pref("ibw.userscript.location.load", "");
pref("ibw.userscript.location.save", "");
